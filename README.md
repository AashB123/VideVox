...
* Audio Output: TRRS Earbuds with Microphone ([Onn Wired Earphones](https://www.walmart.com/ip/onn-Wired-Earphones-with-Mic-3-5mm-jack-Black/416099849?classType=VARIANT&athbdg=L1102&from=/search) recommended) recommended)
